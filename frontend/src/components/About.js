...
export default function About() {
    return (
        <div className='welcome-div row center'>
            <h1 className='about row center' style={{ fontSize: "3rem" }} >
                Rabee Aljaramani<br />
                Web developer<br />
                (+971) 567657124<br />
                ...
                <h1 style={{ backgroundColor: "#FAEBD7", width: "70%", borderRadius: "1rem" }}>
                    ...
                    with a passion for online businesses and would like to join a team of likeminded developers. Constantly striving to
